<template>
    <div>
        <div class="mb-10" v-if="editor">
            <div class="bg-white z-0 flex flex-wrap justify-center items-center">
...
export default {
    ...
    mounted() {
        this.editor = new Editor({
            ...
            editorProps: {
                attributes: {
                    class: 'prose prose-a:text-indigo-500 p-0 focus:outline-none max-w-4xl mx-auto',
                },
            },
