    ...
    <div class="bg-white rounded border border-gray-300">
        ...
        <div class="p-5 border-b border-gray-300" v-if="fieldData.type !== 'divider'">
            ...
            <div v-if="fieldData.type === 'video'">
                <div class="flex items-center">
                    ...
                    <button class="border border-gray-300 rounded-r flex-shrink-0 inline-flex px-5 py-2 text-black hover:bg-brand-blue hover:border-indigo-500 hover:text-indigo-600 transition-all">Add video</button>
                </div>
            </div>
        ...
        <div class="flex items-center p-5">
            ...
            <div class="flex pl-[20px] space-x-[5px]">
                <button @click="$emit('cloneField')" class="bg-white w-[40px] h-[40px] flex justify-center items-center rounded-full hover:bg-brand-blue text-black hover:text-indigo-600 transition-all">
                ...
                <button @click="$emit('delete')" class="bg-white w-[40px] h-[40px] flex justify-center items-center rounded-full hover:bg-brand-blue text-black hover:text-indigo-600 transition-all">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" class="feather feather-trash-2"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path><line x1="10" y1="11" x2="10" y2="17"></line><line x1="14" y1="11" x2="14" y2="17"></line></svg>
                </button>

                <div class="relative" v-if="fieldData.type === 'text'">
                    <button @click="settingsActive = !settingsActive" class="bg-white w-[40px] h-[40px] flex justify-center items-center rounded-full hover:bg-brand-blue text-black hover:text-indigo-600 transition-all">
