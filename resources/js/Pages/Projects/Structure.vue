    ...
    <Layout>
        ...
        <div class="max-w-3xl mx-auto px-4 relative pt-[10px] pb-[100px] ">
            ...
            <div class="fixed bottom-[20px] left-0 w-full flex flex-col items-center justify-center pointer-events-none">
                ...
                <div v-if="!Object.keys(fields).length" class="mb-[30px] animate-bounce rounded-full w-[50px] h-[50px] bg-brand-blue border border-indigo-600 text-indigo-600 flex justify-center items-center">
