        ...
        <div class="max-w-5xl mx-auto px-4 relative" :class="{'pt-[50px] pb-[112px]': Object.keys(fields).length}">
            ...
            <div class="fixed bottom-[20px] left-0 w-full flex flex-col items-center justify-center">
                ...
                <div class="nav-bar shadow p-2 flex items-center space-x-3 border border-gray-300 rounded">
                    ...
                    <button @click="addField('text')" class="h-[50px] w-[50px] flex items-center justify-center bg-white hover:bg-indigo-50 border border-gray-300 hover:border-indigo-500 rounded text-gray-500 hover:text-indigo-500 transition-all relative group">
                    ...
                    <button @click="addField('image')" class="h-[50px] w-[50px] flex items-center justify-center bg-white hover:bg-indigo-50 border border-gray-300 hover:border-indigo-500 rounded text-gray-500 hover:text-indigo-500 transition-all relative group">
                    ...
                    <button @click="addField('video')" class="h-[50px] w-[50px] flex items-center justify-center bg-white hover:bg-indigo-50 border border-gray-300 hover:border-indigo-500 rounded text-gray-500 hover:text-indigo-500 transition-all relative group">
                    ...
                    <button @click="addField('document')" class="h-[50px] w-[50px] flex items-center justify-center bg-white hover:bg-indigo-50 border border-gray-300 hover:border-indigo-500 rounded text-gray-500 hover:text-indigo-500 transition-all relative group">
